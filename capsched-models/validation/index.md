...
| 0319 | Exact G6 run `candidate4-full-20260812T134610Z` proves component-OOM isolation and durable fail-closed finalization but again reaches 7.5 GiB; the successor preserves semantics with persistent exact child/parent histories and a collision-safe fixed-width state index, and passes 275/715/44 fast plus 19 memory-policy cases; clean install is required before G6 retry and G7 remains blocked | Dynamic Residency F0 Candidate-4 G6 Persistent Exact Frontier |
