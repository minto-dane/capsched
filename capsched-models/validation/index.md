...
| 0315 | Dedicated arm64 VM mechanism regressions pass strict C build, launcher basic, 10 launcher-hostile, five snapshot-hostile, five-component supervisor, three guardian, and three reducer cases against a read-only EROFS toolchain; G3-G5 close locally while exact long capture G6 and real-byte reduction G7 remain open | Dynamic Residency F0 Candidate-4 Authority-Disjoint Capture Mechanism |
