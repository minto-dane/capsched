...
jq -n --arg run_id "$RUN_ID" \
	...
	'{schema_version:1,id:"sched-exec-lease-p5a-r4-e4-source-and-e3-regression-result-v1",run_id:$run_id,status:"passed_source_and_six_profile_e3_regression_awaiting_independent_closure",candidate_commit:"4077ba840f713979c29af64f405dbde39f845d93",source_gate_result:$source_result,source_gate_result_sha256:$source_sha,config_smoke_result:$config_result,config_smoke_result_sha256:$config_sha,e3_regression_result:$regression_result,e3_regression_result_sha256:$regression_sha,fresh_source_objects:6,e3_profiles:6,e3_cases_passed:216,e3_receipts:216,e3_handoff_race_strengthened:true,e4_offline_oracle_corrected:true,vcpu_migration_observation_enforced:true,irq_preempt_state_recorded:true,independent_closure_required:true,timing_measurement_may_start:false,r4_e4_source_accepted:false,real_scheduler_attachment:false,runtime_behavior_approved:false,production_protection:false,deployment_ready:false,multi_cluster_ready:false,datacenter_ready:false}' \
	> "$OUT_DIR/result.json.pending"
jq -e '.status == "passed_source_and_six_profile_e3_regression_awaiting_independent_closure" and .fresh_source_objects == 6 and .e3_profiles == 6 and .e3_cases_passed == 216 and .e3_receipts == 216 and .e3_handoff_race_strengthened == true and .e4_offline_oracle_corrected == true and .vcpu_migration_observation_enforced == true and .irq_preempt_state_recorded == true and .independent_closure_required == true and .timing_measurement_may_start == false and .r4_e4_source_accepted == false and .production_protection == false and .datacenter_ready == false' \
