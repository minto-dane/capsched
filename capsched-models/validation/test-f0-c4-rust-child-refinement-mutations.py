...
MUTATIONS = (
    ...
    ("hostile fixture count inflation", record_mutation(("differential_results", "hostile_wf_fixture_slice", "case_count"), 82)),
    ("hostile edge count inflation", record_mutation(("differential_results", "hostile_wf_fixture_slice", "edge_cases"), 23)),
    ("hostile mapped-credit inflation", record_mutation(("differential_results", "hostile_wf_fixture_slice", "mapped_original_case_credits"), 72)),
    ("supplemental edge hidden as credit", record_mutation(("differential_results", "hostile_wf_fixture_slice", "supplemental_edge_cases"), 9)),
