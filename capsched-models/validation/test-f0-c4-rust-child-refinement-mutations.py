...
MUTATIONS = (
    ...
    ("hostile fixture count inflation", record_mutation(("differential_results", "hostile_wf_fixture_slice", "case_count"), 109)),
    ("hostile edge count inflation", record_mutation(("differential_results", "hostile_wf_fixture_slice", "edge_cases"), 23)),
    ("hostile next count inflation", record_mutation(("differential_results", "hostile_wf_fixture_slice", "next_cases"), 28)),
    ("hostile mapped-credit inflation", record_mutation(("differential_results", "hostile_wf_fixture_slice", "mapped_original_case_credits"), 99)),
    ("supplemental case hidden as credit", record_mutation(("differential_results", "hostile_wf_fixture_slice", "supplemental_case_count"), 9)),
    ("exact-state round trip removed", record_mutation(("differential_results", "hostile_wf_fixture_slice", "exact_state_round_trip"), False)),
    ("hostile parity premature completion", record_mutation(("differential_results", "hostile_wf_fixture_slice", "complete_295_case_parity"), True)),
    ("hostile fixture result drift", record_mutation(("differential_results", "hostile_wf_fixture_slice", "result_sha256"), "0" * 64)),
