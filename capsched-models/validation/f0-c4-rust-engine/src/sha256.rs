// Minimal, dependency-free SHA-256 used only for exact model refinement.
// The implementation is checked against NIST vectors and Python-generated
// Candidate-4 grant/receipt digests before differential graph comparison.
