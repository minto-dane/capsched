...
ineligibility, silently drop the candidate, fail closed while an eligible
candidate exists, or use `RETRY_TASK`, idle fallback, sched_ext fallback, core
cached pick, or settled class state as authority.
